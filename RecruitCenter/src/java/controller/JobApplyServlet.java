...
public class JobApplyServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        url.append("mailto:").append(item.getContactEmail()).append(
                "?subject=An%20bright%20potential%20applicant%20has%20seen%20and%20want%20to%20work%20with%20you%20on%20RecruitCenter&body=Dear%20")
                .append(item.getContactName())
                .append("%2C%0A%0AI%20was%20keenly%20interested%20in%20reading%20the%20job%20posting%20for%20the%20position%20of%20")
                .append(item.getJobTitle()).append("%20at%20").append(company.getCompanyName())
                .append(".%20I%20believe%20my%20experience%20is%20a%20strong%20match%20for%20the%20responsibilities%20pertaining%20to%20this%20role%2C%20and%20I%27m%20pleased%20to%20submit%20my%20application%20for%20the%20position.%0A%0A--YOUR%20EXPERIENCE%20HERE--%0A%0AI%20have%20attached%20my%20resume%20to%20this%20letter.%20Through%20it%2C%20I%20hope%20you%20will%20learn%20more%20about%20my%20background%2C%20education%2C%20achievements%2C%20and%20awards.%0A%0AIf%20I%20can%20provide%20you%20with%20any%20further%20information%2C%20please%20let%20me%20know.%20I%20look%20forward%20to%20hearing%20from%20you%20about%20this%20opportunity.%0A%0AThank%20you%20for%20your%20consideration.%0A%0A")
                .append(user.getLname()).append("%20").append(user.getFname()).append("%0A").append(user.getEmail())
                .append("%0A").append(user.getPhonenum());
